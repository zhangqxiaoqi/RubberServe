...
-- ----------------------------
BEGIN;
INSERT INTO `rubber_info` VALUES (1, 1, '公司简介', '12121', '');
INSERT INTO `rubber_info` VALUES (2, 2, '公司荣誉', 'aaa', '');
INSERT INTO `rubber_info` VALUES (3, 3, '公司文化', 'aaaa', '');
INSERT INTO `rubber_info` VALUES (4, 5, '中文内容', 'aaaaa', '');
COMMIT;
...
CREATE TABLE `rubber_news` (
  `ID` int(11) NOT NULL COMMENT 'ID',
  `TITLE_CN` varchar(50)   NOT NULL COMMENT '中文标题',
  `COVER` varchar(255)   NOT NULL COMMENT '封面',
  `CONTENT_CN` text   NOT NULL COMMENT '中文内容',
